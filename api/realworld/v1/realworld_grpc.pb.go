...
type RealWorldClient interface {
	...
	AddComment(ctx context.Context, in *AddCommentRequest, opts ...grpc.CallOption) (*SingleCommentRelpy, error)
	GetComments(ctx context.Context, in *GetCommentsRequest, opts ...grpc.CallOption) (*MultipleCommentsReply, error)
	DeleteComment(ctx context.Context, in *DeleteCommentRequest, opts ...grpc.CallOption) (*SingleCommentRelpy, error)
	...
	GetTags(ctx context.Context, in *GetTagRequest, opts ...grpc.CallOption) (*TagListReply, error)
}
...
func (c *realWorldClient) AddComment(ctx context.Context, in *AddCommentRequest, opts ...grpc.CallOption) (*SingleCommentRelpy, error) {
	out := new(SingleCommentRelpy)
...
func (c *realWorldClient) DeleteComment(ctx context.Context, in *DeleteCommentRequest, opts ...grpc.CallOption) (*SingleCommentRelpy, error) {
	out := new(SingleCommentRelpy)
...
func (c *realWorldClient) GetTags(ctx context.Context, in *GetTagRequest, opts ...grpc.CallOption) (*TagListReply, error) {
...
func (UnimplementedRealWorldServer) AddComment(context.Context, *AddCommentRequest) (*SingleCommentRelpy, error) {
...
func (UnimplementedRealWorldServer) DeleteComment(context.Context, *DeleteCommentRequest) (*SingleCommentRelpy, error) {
...
func (UnimplementedRealWorldServer) GetTags(context.Context, *GetTagRequest) (*TagListReply, error) {
...
func _RealWorld_GetTags_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).GetTags(ctx, req.(*GetTagRequest))
	}
	return interceptor(ctx, in, info, handler)
}
