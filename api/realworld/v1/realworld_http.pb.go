...
type RealWorldHTTPServer interface {
	AddComment(context.Context, *AddCommentRequest) (*SingleCommentRelpy, error)
	...
	DeleteComment(context.Context, *DeleteCommentRequest) (*SingleCommentRelpy, error)
	...
	GetTags(context.Context, *GetTagRequest) (*TagListReply, error)
...
func RegisterRealWorldHTTPServer(s *http.Server, srv RealWorldHTTPServer) {
	...
	r.DELETE("/api/articles/{slug}/comments/{commentid}", _RealWorld_DeleteComment0_HTTP_Handler(srv))
...
type RealWorldHTTPClient interface {
	AddComment(ctx context.Context, req *AddCommentRequest, opts ...http.CallOption) (rsp *SingleCommentRelpy, err error)
	CreateArticles(ctx context.Context, req *CreateArticlesRequest, opts ...http.CallOption) (rsp *SingleArticleReply, err error)
	DeleteArticles(ctx context.Context, req *DeleteArticlesRequest, opts ...http.CallOption) (rsp *SingleArticleReply, err error)
	DeleteComment(ctx context.Context, req *DeleteCommentRequest, opts ...http.CallOption) (rsp *SingleCommentRelpy, err error)
	...
	GetTags(ctx context.Context, req *GetTagRequest, opts ...http.CallOption) (rsp *TagListReply, err error)
...
func (c *RealWorldHTTPClientImpl) AddComment(ctx context.Context, in *AddCommentRequest, opts ...http.CallOption) (*SingleCommentRelpy, error) {
	var out SingleCommentRelpy
...
func (c *RealWorldHTTPClientImpl) DeleteArticles(ctx context.Context, in *DeleteArticlesRequest, opts ...http.CallOption) (*SingleArticleReply, error) {
	var out SingleArticleReply
...
func (c *RealWorldHTTPClientImpl) DeleteComment(ctx context.Context, in *DeleteCommentRequest, opts ...http.CallOption) (*SingleCommentRelpy, error) {
	var out SingleCommentRelpy
	pattern := "/api/articles/{slug}/comments/{commentid}"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *RealWorldHTTPClientImpl) GetTags(ctx context.Context, in *GetTagRequest, opts ...http.CallOption) (*TagListReply, error) {
